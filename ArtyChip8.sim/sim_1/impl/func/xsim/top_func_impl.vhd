...
entity Control is
  port (
    TESTOUT : out STD_LOGIC_VECTOR ( 0 to 0 );
    TESTOUT2 : out STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of Control is
  ...
  signal \OPCODE[9]_i_1_n_0\ : STD_LOGIC;
  signal \OPCODE_reg_n_0_[1]\ : STD_LOGIC;
  signal \^testout\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \^testout2\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \TESTOUT2[1]_i_1_n_0\ : STD_LOGIC;
  signal \TESTOUT[1]_i_1_n_0\ : STD_LOGIC;
  signal p_0_in : STD_LOGIC_VECTOR ( 1 to 1 );
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_onehot_STATE_reg[0]\ : label is "fetch1:0001,fetch2:0010,exec:0100,none:1000";
  attribute FSM_ENCODED_STATES of \FSM_onehot_STATE_reg[1]\ : label is "fetch1:0001,fetch2:0010,exec:0100,none:1000";
  attribute FSM_ENCODED_STATES of \FSM_onehot_STATE_reg[2]\ : label is "fetch1:0001,fetch2:0010,exec:0100,none:1000";
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \OPCODE[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \OPCODE[9]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \TESTOUT2[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \TESTOUT[1]_i_1\ : label is "soft_lutpair7";
begin
  TESTOUT(0) <= \^testout\(0);
  TESTOUT2(0) <= \^testout2\(0);
...
\OPCODE[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\OPCODE[9]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\TESTOUT2[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      ...
      I2 => \^testout2\(0),
      O => \TESTOUT2[1]_i_1_n_0\
    );
\TESTOUT2_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      C => clk_out1,
      CE => '1',
      D => \TESTOUT2[1]_i_1_n_0\,
      Q => \^testout2\(0),
      R => '0'
    );
\TESTOUT[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
      ...
      I1 => \FSM_onehot_STATE_reg_n_0_[2]\,
      I2 => \^testout\(0),
      O => \TESTOUT[1]_i_1_n_0\
    );
\TESTOUT_reg[1]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
architecture STRUCTURE of PmodKYPD is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \Col[1]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \Col[2]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \col_sel[0]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \col_sel[1]_i_1\ : label is "soft_lutpair4";
...
\key_num[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAA8FFECAAA80020"
    )
        port map (
      I0 => p_2_in(0),
      I1 => \key_num[0]_i_3_n_0\,
      I2 => \Col[0]_i_1_n_0\,
...
\key_num[0]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DFFF"
    )
        port map (
...
\key_num[0]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0100100010000000"
    )
        port map (
      I0 => \key_num[0]_i_5_n_0\,
...
\key_num[0]_i_5\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFF7"
    )
        port map (
...
\key_num[2]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0880"
    )
        port map (
...
entity PmodVGA is
  port (
    ...
    TESTOUT : in STD_LOGIC_VECTOR ( 0 to 0 );
    TESTOUT2 : in STD_LOGIC_VECTOR ( 0 to 0 );
    lopt : out STD_LOGIC;
...
architecture STRUCTURE of PmodVGA is
  ...
  signal \vga_red_reg[1]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \vga_red_reg_reg[0]_lopt_replica_1\ : STD_LOGIC;
  signal \vga_red_reg_reg[0]_lopt_replica_2_1\ : STD_LOGIC;
  signal \vga_red_reg_reg[1]_lopt_replica_1\ : STD_LOGIC;
  signal \vga_red_reg_reg[1]_lopt_replica_2_1\ : STD_LOGIC;
  signal \vga_red_reg_reg[2]_lopt_replica_1\ : STD_LOGIC;
  signal \vga_red_reg_reg[2]_lopt_replica_2_1\ : STD_LOGIC;
  signal \vga_red_reg_reg[3]_i_12_n_0\ : STD_LOGIC;
  signal \vga_red_reg_reg[3]_lopt_replica_1\ : STD_LOGIC;
  signal \vga_red_reg_reg[3]_lopt_replica_2_1\ : STD_LOGIC;
  ...
  signal \NLW_vga_red_reg_reg[3]_i_12_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_vga_red_reg_reg[3]_i_12_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_vga_red_reg_reg[3]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \h_pxl[0]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \h_pxl[2]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \h_pxl[3]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \h_pxl[4]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \h_pxl_cntr[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \h_pxl_cntr[2]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \h_pxl_cntr[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \h_pxl_cntr[4]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \h_pxl_cntr[7]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \h_pxl_cntr[8]_i_3\ : label is "soft_lutpair14";
  attribute \PinAttr:I2:HOLD_DETOUR\ : integer;
  attribute \PinAttr:I2:HOLD_DETOUR\ of \h_pxl_cntr[8]_i_5\ : label is 145;
  ...
  attribute SOFT_HLUTNM of \v_pxl[1]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \v_pxl[2]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \v_pxl[3]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \v_pxl[4]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \v_pxl_cntr[0]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \v_pxl_cntr[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \v_pxl_cntr[2]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \v_pxl_cntr[3]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \v_pxl_cntr[7]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \v_pxl_cntr[8]_i_3\ : label is "soft_lutpair15";
  ...
  attribute OPT_INSERTED_REPDRIVER of \vga_red_reg_reg[0]_lopt_replica\ : label is std.standard.true;
  attribute OPT_MODIFIED of \vga_red_reg_reg[0]_lopt_replica\ : label is "SWEEP";
  attribute OPT_INSERTED_REPDRIVER of \vga_red_reg_reg[0]_lopt_replica_2\ : label is std.standard.true;
  attribute OPT_MODIFIED of \vga_red_reg_reg[0]_lopt_replica_2\ : label is "SWEEP";
  attribute OPT_INSERTED_REPDRIVER of \vga_red_reg_reg[1]_lopt_replica\ : label is std.standard.true;
  attribute OPT_MODIFIED of \vga_red_reg_reg[1]_lopt_replica\ : label is "SWEEP";
  attribute OPT_INSERTED_REPDRIVER of \vga_red_reg_reg[1]_lopt_replica_2\ : label is std.standard.true;
  attribute OPT_MODIFIED of \vga_red_reg_reg[1]_lopt_replica_2\ : label is "SWEEP";
  ...
  attribute OPT_INSERTED_REPDRIVER of \vga_red_reg_reg[2]_lopt_replica_2\ : label is std.standard.true;
  attribute OPT_MODIFIED of \vga_red_reg_reg[2]_lopt_replica_2\ : label is "SWEEP";
  attribute COMPARATOR_THRESHOLD of \vga_red_reg_reg[3]_i_12\ : label is 11;
  attribute OPT_MODIFIED of \vga_red_reg_reg[3]_i_12\ : label is "SWEEP";
  attribute COMPARATOR_THRESHOLD of \vga_red_reg_reg[3]_i_3\ : label is 11;
  attribute OPT_MODIFIED of \vga_red_reg_reg[3]_i_3\ : label is "SWEEP";
  attribute COMPARATOR_THRESHOLD of \vga_red_reg_reg[3]_i_4\ : label is 11;
  attribute OPT_INSERTED_REPDRIVER of \vga_red_reg_reg[3]_lopt_replica\ : label is std.standard.true;
  attribute OPT_MODIFIED of \vga_red_reg_reg[3]_lopt_replica\ : label is "SWEEP";
  attribute OPT_INSERTED_REPDRIVER of \vga_red_reg_reg[3]_lopt_replica_2\ : label is std.standard.true;
  attribute OPT_MODIFIED of \vga_red_reg_reg[3]_lopt_replica_2\ : label is "SWEEP";
begin
  lopt <= \vga_red_reg_reg[0]_lopt_replica_1\;
  lopt_1 <= \vga_red_reg_reg[0]_lopt_replica_2_1\;
  lopt_10 <= \vga_red_reg_reg[3]_lopt_replica_2_1\;
  lopt_3 <= \vga_red_reg_reg[1]_lopt_replica_1\;
  lopt_4 <= \vga_red_reg_reg[1]_lopt_replica_2_1\;
  lopt_6 <= \vga_red_reg_reg[2]_lopt_replica_1\;
  lopt_7 <= \vga_red_reg_reg[2]_lopt_replica_2_1\;
  lopt_9 <= \vga_red_reg_reg[3]_lopt_replica_1\;
  lopt_11 <= 'Z';
  lopt_2 <= 'Z';
  lopt_5 <= 'Z';
  lopt_8 <= 'Z';
...
\vga_red_reg[1]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"4A400000"
    )
        port map (
...
\vga_red_reg_reg[0]_lopt_replica\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\vga_red_reg_reg[0]_lopt_replica_2\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
\vga_red_reg_reg[1]_lopt_replica\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => '1',
      D => \vga_red_reg[1]_i_1_n_0\,
      Q => \vga_red_reg_reg[1]_lopt_replica_1\,
      R => p_0_in
    );
\vga_red_reg_reg[1]_lopt_replica_2\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => '1',
      D => \vga_red_reg[1]_i_1_n_0\,
      Q => \vga_red_reg_reg[1]_lopt_replica_2_1\,
      R => p_0_in
    );
...
\vga_red_reg_reg[2]_lopt_replica_2\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => '1',
      D => \vga_red_reg[2]_i_1_n_0\,
      Q => \vga_red_reg_reg[2]_lopt_replica_2_1\,
      R => p_0_in
    );
...
\vga_red_reg_reg[3]_i_12\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_vga_red_reg_reg[3]_i_12_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
      DI(3 downto 2) => B"00",
...
\vga_red_reg_reg[3]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2) => ltOp6_in,
      CO(1 downto 0) => \NLW_vga_red_reg_reg[3]_i_3_CO_UNCONNECTED\(1 downto 0),
      CYINIT => '0',
      DI(3) => '0',
...
\vga_red_reg_reg[3]_lopt_replica\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => '1',
      D => \vga_red_reg[3]_i_2_n_0\,
      Q => \vga_red_reg_reg[3]_lopt_replica_1\,
      R => p_0_in
    );
\vga_red_reg_reg[3]_lopt_replica_2\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
      ...
      CE => '1',
      D => \vga_red_reg[3]_i_2_n_0\,
      Q => \vga_red_reg_reg[3]_lopt_replica_2_1\,
      R => p_0_in
    );
end STRUCTURE;
library IEEE;
...
entity top is
  ...
  attribute ECO_CHECKSUM of top : entity is "99d52bef";
end top;
...
architecture STRUCTURE of top is
  ...
  signal TESTOUT : STD_LOGIC_VECTOR ( 1 to 1 );
  signal TESTOUT2 : STD_LOGIC_VECTOR ( 1 to 1 );
  ...
  signal NLW_VGA_lopt_11_UNCONNECTED : STD_LOGIC;
  signal NLW_VGA_lopt_2_UNCONNECTED : STD_LOGIC;
  signal NLW_VGA_lopt_5_UNCONNECTED : STD_LOGIC;
  signal NLW_VGA_lopt_8_UNCONNECTED : STD_LOGIC;
  ...
  attribute OPT_MODIFIED : string;
  attribute OPT_MODIFIED of \VGA_B_OBUF[0]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \VGA_B_OBUF[1]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \VGA_B_OBUF[2]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \VGA_B_OBUF[3]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \VGA_G_OBUF[0]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \VGA_G_OBUF[1]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \VGA_G_OBUF[2]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \VGA_G_OBUF[3]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \VGA_R_OBUF[0]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \VGA_R_OBUF[1]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \VGA_R_OBUF[2]_inst\ : label is "SWEEP";
  attribute OPT_MODIFIED of \VGA_R_OBUF[3]_inst\ : label is "SWEEP";
begin
...
SYS_CNTRL: entity work.Control
     port map (
      TESTOUT(0) => TESTOUT(1),
      TESTOUT2(0) => TESTOUT2(1),
      clk_out1 => Clk
    );
VGA: entity work.PmodVGA
     port map (
      ...
      lopt_1 => lopt_1,
      lopt_10 => lopt_10,
      lopt_11 => NLW_VGA_lopt_11_UNCONNECTED,
      lopt_2 => NLW_VGA_lopt_2_UNCONNECTED,
      lopt_3 => lopt_3,
      lopt_4 => lopt_4,
      lopt_5 => NLW_VGA_lopt_5_UNCONNECTED,
      lopt_6 => lopt_6,
      lopt_7 => lopt_7,
      lopt_8 => NLW_VGA_lopt_8_UNCONNECTED,
      lopt_9 => lopt_9
    );
