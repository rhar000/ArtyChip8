...
REM
REM Generated by Vivado on Wed Mar 23 08:38:51 -0400 2022
...
echo "xvhdl --incr --relax -prj test_Main_vhdl.prj"
call xvhdl  --incr --relax -prj test_Main_vhdl.prj -log xvhdl.log
